document.addEventListener("DOMContentLoaded", function() {
  ...
  var themeToggleTexts = document.querySelectorAll(".theme-toggle-text");
  var menuToggle = document.querySelector(".menu-toggle");
  var navMenu = document.querySelector(".nav-links");
  var interactiveCards = document.querySelectorAll(
    ".project-card, .stack-card, .cert-card"
  );
  ...
  function applyTheme(theme) {
    ...
    themeToggles.forEach(function(themeToggle) {
      themeToggle.setAttribute(
        "aria-label",
        "Switch to " + nextLabel.toLowerCase() + " mode"
      );
      themeToggle.setAttribute(
        "aria-pressed",
    ...
    themeToggleTexts.forEach(function(themeToggleText) {
